...
class MyDBHelper(context:Context) : SQLiteOpenHelper(context,"ProductsDB",null,1) {
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        db?.execSQL("INSERT INTO PRODUCTS(CATEGORY,PRODUCTNAME,QUANTITY,DESCRIPTION,PRICE,COUNTRY) VALUES('vegetables','Local Tomato','500g','Big Red, Juicy, Healthy!',1.60,'NZ')")
